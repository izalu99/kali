                ...
                <div className='flex flex-col w-full lg:w-1/2'>
                    ...
                    <form onSubmit={handleWordSubmit} className="space-y-4">
                        ...
                        <div className='flex flex-col'>
                            ...
                            <input className="bg-gray-100 p-2 rounded-lg text-black" placeholder='Word text' required></input>
                        </div>
    
                        <div className='flex flex-col'>
                            <label className="font-medium text-black mb-2">Word Type</label>
                            <input className="bg-gray-100 p-2 rounded-lg text-black" placeholder='e.g., adjective, adverb, noun, verb,...'></input>
                        </div>
    
                        <div className='flex flex-col'>
                            <label className="font-medium text-black mb-2">Tense</label>
                            <input className="bg-gray-100 p-2 rounded-lg text-black" placeholder='e.g., past, present, future'></input>
                        </div>
    
                        <div className='flex flex-col'>
                            <label className="font-medium text-black mb-2">Example Sentence</label>
                            <input className="bg-gray-100 p-2 rounded-lg text-black" placeholder='Example'></input>
                        </div>
                ...
                <div className='flex flex-col w-full lg:w-1/2'>
                    ...
                    <form onSubmit={handleTranslationSubmit} className="space-y-4">
                        ...
                        <div className='flex flex-col'>
                            ...
                            <input className="bg-gray-100 p-2 rounded-lg text-black" placeholder='Translation text' required></input>
                        </div>
                        
                        <div className='flex flex-col'>
                            <label className="font-medium text-black mb-2">Translation Language</label>
                            <input className="bg-gray-100 p-2 rounded-lg text-black" placeholder='e.g., English' required></input>
                        </div>
